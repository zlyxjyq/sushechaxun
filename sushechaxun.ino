...
#define DEVICEID   "23248299"
#define PROJECTID "113048"
#define HOST_PORT   (80)
String apiKey="x6=np0UwzAjUPTCgdF2flCO3XGY=";
char buf[10];

#define INTERVAL_sensor 2000
unsigned long sensorlastTime = millis();

float  lightnessOLED,humansensorOLED;
...
//3,传感器值的设置 
float  sensor_lux,sensor_hum;                    //传感器光照   
char   sensor_lux_c[7],sensor_hum_c[7] ;    //换成char数组传输
...
bool  sensorReading = digitalRead(humanHotSensor);
